...
public class MemberVO {
	...
	public MemberVO(String name, String email, String password, String mobile, String postcode, String address,
			String detailAddress, String extraAddress, String gender, String birthday, String[] taste, String point) {
		super();
		this.name = name;
		this.email = email;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public String getStrTaste() { // taste 배열을 하나의 문자열로 리턴
		if(taste != null) {
			return String.join(",", taste);
		}
		else {
			return "";
		}
