	...
	<div id="mycontainer">
		...
		<div id="headerImg">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="http://www.samsung.com"><img
						src="<%=ctxPath%>/images/logo1.png" /></a>
				</div>
				<div class="col-md-2">
		...
		<div id="sideinfo">
			<div class="row">
				<div class="col-md-12"
					style="height: 50px; text-align: left; padding: 20px;">2.
					로그인/Tree/View</div>
			<%--	<%@ include file="/WEB-INF/login/login.jsp"%>   --%>
			</div>
			<div class="row">
				<div class="col-md-12" id="sideconent"
					style="text-align: left; padding: 20px;"></div>
			</div>
		</div>
